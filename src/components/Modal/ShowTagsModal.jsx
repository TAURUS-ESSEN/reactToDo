...
export default function ShowTagsModal({categories, tasks, setTasks, setCategories, openModal, closeModal, setToasts, tags, setTags}) {
                    ...
                    return <li key = {c.id}>
                        <div className = {styles.currentCategoryBlock}>
                            ...
                            {(!showBlocks.hideDeleteButton || showBlocks.id !== c.id)  && (
                                <span>
                                    <button onClick={() => preDelete(c.id, taskNumbers)} className={styles.preDeleteButton} title="Delete Category"><i className="fa-solid fa-trash-can"></i> Delete </button>                                    
                                </span>
                            )}
                        </div>
